...
class CityController {
    ...
    public function getCities() {
        ...
        if(empty(\$cities)) {
            echo json_encode(['success' => true, 'data' => [], 'message' => 'No hay ciudades']);
            return;
        }
        ...
        foreach(\$cities as \$city) {
            ...
            \$result[] = [
                ...
                'scale' => \$scale,
                'scale_class' => \$scale >= 8 ? 'high' : (\$scale >= 5 ? 'medium' : 'low')
            ];
        }
...
?>
"@ | Out-File -FilePath app\controllers\CityController.php -Encoding UTF8